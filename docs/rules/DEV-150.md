...
enforcement: "manual"
severity: "error"
depends_on: ["DEV-110", "DEV-140"]
---

## Keep the Spec as Unimplemented Behavior and Graduate It

### Problem

When a Spec describes behavior that already shipped, or `docs/` describes
