...
<!-- Description: Every user type the actions below name, operators and administrators included. Link a type the product docs already define. For a new or changed type, give the definition and who creates the account. For an account created outside the product, also say whether the product can create more. -->
...
<!-- Description: Required object. Accounts are managed here like any other object, not in a separate administration area. Keep only the capabilities this Goal adds or changes, and link the product docs for the rest. -->
...
<!-- Description: A core entity or concept the user interacts with (e.g., "Invoice", "Project"). Repeat this section for each distinct object. Keep only the capabilities this Goal adds or changes, and link the product docs for the rest. -->
